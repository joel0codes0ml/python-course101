...
export default function Sharingan({ size = "w-12 h-12", animate = true }) {
  return (
    <div className={`${size} relative rounded-full bg-[#cc0000] border-2 border-black shadow-[0_0_20px_rgba(204,0,0,0.5)] flex items-center justify-center ${animate ? 'animate-pulse' : ''}`}>
      {/* Pupil */}

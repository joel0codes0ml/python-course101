export const htmlLessons = [
  ...
  },
  {
    ...
    content: "Headings define sections. Use <h1> to <h6> for different heading sizes. :contentReference[oaicite:0]{index=0}",
  ...
  },
  {
    ...
    content: "Create ordered (<ol>) and unordered (<ul>) lists. :contentReference[oaicite:1]{index=1}",
    starterCode: `<ul>\n  <li>Item A</li>\n  <li>Item B</li>\n</ul>`
  },
  {
  ...
  },
  {
    ...
    content: "Add images using <img> with src and alt attributes. :contentReference[oaicite:2]{index=2}",
  ...
  },
  {
    ...
    content: "Create tabular data with <table>, <tr>, <th>, <td>. :contentReference[oaicite:3]{index=3}",
    starterCode: `<table>\n  <tr><th>Col1</th><th>Col2</th></tr>\n  <tr><td>A</td><td>B</td></tr>\n</table>`
  },
  {
    title: "Lesson 11: Forms",
    content: "Basic forms use <form>, <input>, <button>. :contentReference[oaicite:4]{index=4}",
  ...
  },
  {
    ...
    content: "Use semantic tags: <header>, <nav>, <main>, <footer>. :contentReference[oaicite:5]{index=5}",
